<x-layouts.auth title="Gangguan Air">
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <flux:breadcrumbs class="py-3 mb-4">
            ...
            <flux:breadcrumbs.item>Data Gangguan Air</flux:breadcrumbs.item>
        </flux:breadcrumbs>
            ...
            <div class="col-xl">
                <div class="card mb-4">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h5 class="mb-0">Data Gangguan Air</h5>
                        <small class="text-muted float-end">
                            <a href="{{ route('admin.gangguan-air.create') }}"
    ...
    @push('js')
        ...
        <script>
            let datatable = $(".datatable").DataTable({
                ...
                responsive: true,
                ajax: {
                    url: "{{ route('admin.gangguan-air.index') }}",
                    type: 'GET',
